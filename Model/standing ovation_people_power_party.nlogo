...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot mean [government-legitimacy] of turtles"
...
@#$#@#$#@
<experiments>
  <experiment name="new 당론 압박" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
  ...
  <experiment name="new 이웃 동조 효과" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <exitCondition>(ticks &gt; 10 and count turtles with [shape = "triangle" and standing?] &gt;= 8)</exitCondition>
  ...
  <experiment name="new 시야" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <exitCondition>(ticks &gt; 10 and count turtles with [shape = "triangle" and standing?] &gt;= 8)</exitCondition>
  ...
  <experiment name="new 입장 압력" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <exitCondition>(ticks &gt; 10 and count turtles with [shape = "triangle" and standing?] &gt;= 8)</exitCondition>
  ...
  <experiment name="뉴" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <exitCondition>(ticks &gt; 10 and count turtles with [shape = "triangle" and standing?] &gt;= 8)</exitCondition>
  ...
  <experiment name="뉴 (copy)" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <exitCondition>(ticks &gt; 10 and count turtles with [shape = "triangle" and standing?] &gt;= 8)</exitCondition>
